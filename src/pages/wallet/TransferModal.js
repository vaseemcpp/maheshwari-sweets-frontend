...
import { selectReceiverName,RESET_RECEIVER } from "../../redux/features/transaction/transactionSlice";
...
const TransferModal = ({
 ...
 const receiverName = useSelector(selectReceiverName)
  ...
  return (
    <section className="--100vh modal-section " onClick={closeModal}>
          ...
          <div className="modal-body">
            <form onSubmit={onSubmit}>
              ...
              <p>
                ...
                <p className="--text-sm"><b className="--color-danger">Receiver Name:</b>{receiverName}</p>
